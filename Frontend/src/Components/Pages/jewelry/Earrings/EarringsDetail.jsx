...
import EarringsDetail2 from './EarringsDetail2';
...
const EarringsDetail = () => {
    ...
    useEffect(() => {
        ...
        if (product && product.id === EarringsId) {
            setLoading(false);
            return;
        }
        ...
        const fetchProductDetails = async () => {
            ...
            setError(null);
            try {
                const response = await fetch(`${API_URL}/api/products/${EarringsId}`);
                ...
                <div className="pdp-page-wrapper">
                    ...
                    <div className="pdp-main-content">
                        <div className="pdp-main-media-container">
                            ...
                            {mediaItems.length > 1 && (
                                <>
                                    <button onClick={handlePrevMedia} className="pdp-nav-arrow-Earrings pdp-prev"><BsArrowLeftShort /></button>
                                    <button onClick={handleNextMedia} className="pdp-nav-arrow-Earrings pdp-next"><BsArrowRightShort /></button>
                                </>
                            )}
                        </div>
