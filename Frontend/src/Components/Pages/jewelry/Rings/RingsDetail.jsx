...
import RingsDetail2 from './RingsDetail2';
...
const RingsDetail = () => {
    ...
    useEffect(() => {
        ...
        const fetchProductDetails = async () => {
            ...
            setError(null);
            try {
                const response = await fetch(`${API_URL}/api/products/${RingsId}`);
                ...
                <div className="pdp-page-wrapper">
                    ...
                    <div className="pdp-main-content">
                        <div className="pdp-main-media-container">
                            ...
                            {mediaItems.length > 1 && (
                                <>
                                    <button onClick={handlePrevMedia} className="pdp-nav-arrow-rings pdp-prev"><BsArrowLeftShort /></button>
                                    <button onClick={handleNextMedia} className="pdp-nav-arrow-rings pdp-next"><BsArrowRightShort /></button>
                                </>
                            )}
                        </div>
