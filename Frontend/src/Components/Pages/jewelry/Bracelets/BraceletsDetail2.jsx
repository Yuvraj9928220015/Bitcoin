        ...
        <>
            <div className="product-details-page">
                    ...
                    <div className="bvlgari-content-wrapper">
                        <div className="bvlgari-text-content">
                            <h2 className="section-title">
                                Complimentary Bitcoin signature box with every order
                            </h2>
                            <p className="section-description">
                                Every creation is carefully handcrafted and delivered in iconic Bitcoin packaging, inspired by the splendour of the Eternal City.
                            </p>
                            <p className="section-description">
                                Designed to preserve Bitcoin's magnificent creations over time, the packaging contains no harmful chemicals and is made from paper sourced from sustainable forests, wood fibre, 100% pure silk and natural latex from rubber trees.
                            </p>
                ...
                <section data-aos="fade-up" className="exclusive-section">
                    <div className="exclusive-section-title">Exclusive Bitcoin services</div>
...
export default BraceletsDetail2;