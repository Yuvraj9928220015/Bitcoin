...
import BraceletsDetail2 from './BraceletsDetail2';
            ...
            <div className="product-modal-content" onClick={e => e.stopPropagation()}>
                ...
                <form onSubmit={handleSubmit} className="question-form">
                    ...
                    <div className="form-group">
                        ...
                        <textarea id="question" name="question" rows="4" required placeholder="Type your question here..."></textarea>
                    </div>
...
const BraceletsDetail = () => {
    ...
    useEffect(() => {
        ...
        if (product && product.id === BraceletsId) {
            setLoading(false);
            return;
        }
        ...
        const fetchProductDetails = async () => {
            ...
            setError(null);
            try {
                const response = await fetch(`${API_URL}/api/products/${BraceletsId}`);
                ...
                <div className="pdp-page-wrapper">
                    ...
                    <div className="pdp-main-content">
                        <div className="pdp-main-media-container">
                            ...
                            {mediaItems.length > 1 && (
                                <>
                                    <button onClick={handlePrevMedia} className="pdp-nav-arrow-bracelets pdp-prev"><BsArrowLeftShort /></button>
                                    <button onClick={handleNextMedia} className="pdp-nav-arrow-bracelets pdp-next"><BsArrowRightShort /></button>
                                </>
                            )}
                        </div>
