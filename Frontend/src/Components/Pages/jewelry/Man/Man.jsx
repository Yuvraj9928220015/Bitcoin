            ...
            <>
                <div className="">
                    <div data-aos="fade-up" className="bzero-page-container">
                        <div data-aos="fade-up" className={`bzero-main-content ${isFilterOpen ? 'content-blurred' : ''}`}>
                            <header className="bzero-header">
                                <div className="bzero-header-left">
                                    <span className="breadcrumb">Jewelry / Man</span>
                                ...
                                <div className="product-grid">
                                    ...
                                    <div className="product-grid-right">
                                        <div className="hero-image-container">
                                            <img src="/Man-Banner-1.JPG" alt="Model wearing Pendants" />
                                        </div>
                                    </div>
                                </div>
                            </main>
